...
Private Const Ship2Left = 1320


Private Const PadTop = 3840 '3720 '3840
Private Const PadLeft = 1080

Private Const OffPadDrop = 3880
...
lblHighScore = "H.Score: " & GetSetting("Moonlander", "Options", "HighScore", 0)
...
If Not Level = 1 Then
If dd = 1 Then Shape1.Left = Shape1.Left - 15
If dd = 2 Then Shape1.Left = Shape1.Left + 15
End If
...
If Not Level = 5 Then NewLevel (Level + 1)
